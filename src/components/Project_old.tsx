        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {projects.map((project) => (
            <div
              ...
              className="group relative border border-border rounded-lg p-6 card-hover bg-card overflow-hidden"
            >
              ...
              {/* {project.image && (
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10">
                  <img
                    src={project.image}
                    alt={project.title}
                    className="w-[90%] h-auto rounded-lg shadow-2xl scale-90 group-hover:scale-100 transition-transform duration-300"
                  />
                </div>
              )} */}
